  ...
  const categories = [
    {
      ...
      description: "Hộp quà truyền thống cho Tết Nguyên Đán"
    },
    {
      name: "Hộp Rượu Vang",
      ...
      description: "Rượu vang cao cấp với bao bì sang trọng"
    },
    {
      name: "Quà Sức Khỏe",
      ...
      description: "Bộ quà tặng chăm sóc sức khỏe"
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {categories.map((category, index) => (
            ...
            >
              ...
              {/* Border accent */}
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#B71C1C] to-[#D4AF37] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
            </div>
          ))}
        </div>
      </div>
