...
export function CorporateSection({ onNavigate }: CorporateSectionProps) {
  return (
    <section className="py-20 bg-gradient-to-br from-[#B71C1C] to-[#8B0000] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            {/* Decorative Element */}
            <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-[#D4AF37] rounded-full opacity-20 blur-2xl"></div>
          </div>
        </div>
      </div>
    </section>
