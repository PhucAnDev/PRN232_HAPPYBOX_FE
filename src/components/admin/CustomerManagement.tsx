...
export function CustomerManagement() {
  ...
  const getTypeBadge = (type: string, isVip: boolean) => {
    if (isVip) {
      return (
  ...
  const handleSaveCustomer = () => {
    const newCustomer: Customer = {
      ...
      type: formData.type as "individual" | "enterprise",
      isVip: false,
      totalOrders: 0,
      totalSpent: 0,
  ...
  const filteredCustomers = customers.filter((customer) => {
    ...
    const matchesType =
      ...
      (typeFilter === "individual" && customer.type === "individual" && !customer.isVip) ||
                    ...
                    <div className="text-center space-y-1">
                      ...
                      <p
                        className={`text-sm font-bold ${
                          customer.isVip || customer.totalSpent >= 30000000
                            ? "text-[#D4AF37]"
                            : "text-gray-900"
                        }`}
                      >
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      onClick={() =>
                        setFormData({ ...formData, type: "enterprise" })
                      }
                      className={`flex-1 px-4 py-3 rounded-lg border-2 transition-all ${
