...
export function OrderTracking({ onNavigate }: OrderTrackingProps) {
  ...
  const [showResult, setShowResult] = useState(true); // Set to true to show demo result
  ...
  const orderData = {
    ...
    currentStatus: 2, // 0: Pending, 1: Processing, 2: Shipping, 3: Completed
    customer: {
    ...
    items: [
      {
        id: 1,
        name: "Hộp Quà Tết Phúc Lộc Thọ Deluxe",
      ...
      {
        id: 2,
        name: "Hộp Quà Tết Tài Lộc Vàng Premium",
  ...
  return (
    <div className="bg-[#FFFDF5] min-h-screen" style={{ fontFamily: "'Montserrat', sans-serif" }}>
            ...
            <div className="bg-white rounded-b-2xl shadow-xl border-x border-b border-gray-200">
              ...
              <div className="px-8 py-12 border-b border-gray-200">
                        ...
                        <div key={step.id} className="flex flex-col items-center">
                          ...
                          {(isCompleted || isActive) && (
                            <p className="text-xs text-green-600 font-semibold mt-1">
                              {isActive ? 'Đang xử lý' : '✓ Hoàn thành'}
                            </p>
                          )}
                        </div>
                      );
                ...
                {orderData.currentStatus === 2 && (
                  <div className="mt-8 bg-[#D4AF37]/10 border border-[#D4AF37]/30 rounded-lg p-4">
              ...
              <div className="px-8 py-8">
                ...
                <div className="space-y-4">
                  {orderData.items.map((item) => (
                    <div key={item.id} className="flex items-center gap-4 p-4 bg-[#FFFDF5] rounded-lg border border-gray-200">
                      <ImageWithFallback
                        src={item.image}
                        alt={item.name}
