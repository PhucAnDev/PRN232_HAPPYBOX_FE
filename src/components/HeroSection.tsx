...
export function HeroSection() {
  ...
  const slides = [
    {
      ...
      subtitle: "Bộ sưu tập Phúc Lộc Thọ 2026"
    },
    {
      ...
      title: "Bộ Sưu Tập Quà Tặng Sang Trọng",
      subtitle: "Hoàn hảo cho Quà Tặng Doanh Nghiệp"
    }
  ];
  ...
  return (
    <section className="relative h-[600px] bg-gradient-to-r from-[#B71C1C] to-[#8B0000] overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#B71C1C]/80 to-transparent"></div>
      </div>
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`h-2 rounded-full transition-all ${
              index === currentSlide ? "w-8 bg-[#D4AF37]" : "w-2 bg-white/50"
            }`}
          />
        ))}
      </div>
